...
def server_function(dir, entries, dead):
	...
	while not dead or total_log_files == 10:
...
#função que instancia e inicia os simuladores dos servidores HTTP
def start_servers(total_servers=4):
...
if __name__ == '__main__':
	...
	#começa a execução dos servidores
